...
<h2 style="margin-top: 70px;margin-left: 250px ">正在开发中......</h2>
...
<script>
     function x() {
         var str="  <tr>\n" +
             ...
             "                    <td>datalist[i].temperature</td>\n" +
             "                    <td>datalist[i].humidity</td>\n" +
             "                    <td>datalist[i].mq2</td>\n" +
             "                    <td>datalist[i].mq135</td>\n" +
             "                    <td>福建省三明市三元区荆西街道三明学院数学与计算机科学系三明学院</td>\n" +
