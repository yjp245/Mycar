    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  typeof="<button disabled></button>"  id=" " name="" value="${user.uname}" readonly>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  typeof="<button disabled></button>"  id="usex" name="user" value="${user.usex}" readonly>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  typeof="<button disabled></button>"  id=" " name="user" value="${login.l_user}" readonly>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  typeof="<button disabled></button>"  id="phone " name="" value="${user.uphone}" readonly>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  typeof="<button disabled></button>"  id="uemail" name="user" value="${user.uemail}" readonly>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;重置密码&nbsp;" onclick="resetPass()">
            </div>
        </div>
    </form>
</article>
