...
<h2 style="text-align: center;margin-top: 60px" id="title"></h2>
<p style="margin-top:70px;padding-left: 75px;padding-right: 75px;font-family: 楷体;font-size: 24px" id="content">
