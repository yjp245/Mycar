    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="设备编号" id="dnum" name="dnum">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="通信密码" id="dpass" name="dpass">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>设备名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="设备名称" name="dname" id="dname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">备注：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="beizhu" id="beizhu" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="textarealength(this,100)"></textarea>
        ...
        $("#form-member-add").validate({
           ...
           //focusCleanup:true,
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit();
                var uid="${loginUserUid}";
             $.post("${APP_PATH}/jsondata/device-add.do",{
                 uid:uid,
                 dnum:$('#dnum').val(),
                 dname:$('#dname').val(),
                 dpass:$('#dpass').val(),
                 ...
                 if(data=="ok"){
                     ...
                     $.Huimodalalert('该设备以绑定，请重新输入',2000);
                 }
             });
