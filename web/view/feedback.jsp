...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 信息反馈<span class="c-gray en">&gt;</span> 问题反馈
</nav>
        ...
        <div class="panel-body">
            ...
            <form class="" action="" method="post">
                ...
                <div class="row cl" style="margin-bottom: 30px">
                    ...
                    <label class="form-label col-xs-4 col-sm-3"> <text style="margin-left: 150px">问题反馈：</text></label>
                    <div class="formControls col-xs-5 col-sm-9">
                        <textarea class="textarea" placeholder="请详细描述你所遇到的问题" rows="" cols="" name="probelm" id="probelm"></textarea>
                    </div>
                </div>
                <div class="row cl" style="margin-bottom: 30px">
                    <label class="form-label col-xs-4 col-sm-3"> <text style="margin-left: 150px">联系方式：</text></label>
                    <div class="formControls col-xs-5 col-sm-9">
                        <input type="text" class="input-text radius" name="phone" id="phone" placeholder="请留下你的联系方式（QQ/微信、电话、等）">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function submitfeedback(){
        var probelm=$("#probelm").val();
        var phone= $("#phone").val();
        if(probelm != "" && phone != ""){

            $.post("${APP_PATH}/jsondata/sendFeedBack.do",{
                probelm:probelm,
                phone:phone
            },function (str) {
