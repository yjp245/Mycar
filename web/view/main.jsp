...
<body>
<header class="navbar-wrapper" style="">
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${loginUserInfo.getUname()}<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="user/logoOut.do">切换账户</a></li>
                        </ul>
                    </li>
                 <%--   <li id="Hui-msg"> <a href="#" title="消息"><span class="badge badge-danger">1</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>--%>
                    <li id="Hui-skin" class="dropDown right dropDown_hover"> <a href="javascript:;" class="dropDown_A" title="换肤"><i class="Hui-iconfont" style="font-size:18px">&#xe62a;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="javascript:;" data-val="blue" title="蓝色">蓝色
                            </a></li>
...
<aside class="Hui-aside" style="">
    <div class="menu_dropdown bk_2">
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${APP_PATH}/driver-list.do" data-title="设备列表" href="javascript:void(0)">设备列表</a></li>
                    <li><a data-href="${APP_PATH}/data-list.do" data-title="数据查看" href="javascript:void(0)">数据查看</a></li>
                    <li><a data-href="${APP_PATH}/view/baidumap.jsp" data-title="设备定位" href="javascript:void(0)">设备定位</a></li>
                    <li><a data-href="${APP_PATH}/view/safeseting.jsp" data-title="安全设置" href="javascript:void(0)">安全设置</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="${APP_PATH}/view/userselfinfo.jsp" data-title="信息修改" href="javascript:void(0)">信息修改</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li><a data-href="${APP_PATH}/view/feedback.jsp" data-title="问题反馈" href="javascript:;">问题反馈</a></li>
                    <li><a data-href="${APP_PATH}/toNoticelist2.do" data-title="公告查看" href="javascript:;">公告查看</a></li>
        ...
        <dl id="menu-member">
            <dt><i class="Hui-iconfont">&#xe640;</i> 软件下载<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="${APP_PATH}/view/download.jsp" data-title="客户端下载" href="javascript:;">客户端下载</a></li>
                </ul>
            </dd>
        </dl>

        <dl id="menu-comments">
            <dt><i class="Hui-iconfont">&#xe61d;</i> 系统简介<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="${APP_PATH}/view/product.jsp" data-title="系统简介" href="javascript:;">系统简介</a></li>
                </ul>
            </dd>
        </dl>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="${APP_PATH}/view/welcome.jsp">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${APP_PATH}/view/welcome.jsp"></iframe>
        </div>
    </div>
</section>
